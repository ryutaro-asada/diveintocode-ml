...
# 背景のパス
background_path = 'pet-bottle-pic/test/back_graund.jpeg'

# テンプレート:登録商品のパス
temp_path = "pet-bottle-pic/test/template_pic"

# # 写真撮影した場合のパス
# photo_filename = 'take_pic.jpg'

# 精度確認テスト用のパス
path_camera_pic = "pet-bottle-pic/test/camera_pic"
